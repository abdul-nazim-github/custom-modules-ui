  ...
  try {
    ...
    try {
      ...
      if (axios.isAxiosError(backendError)) {
        console.error('Backend user update error status:', backendError.response?.status);
        console.error('Backend user update error message:', backendError.response?.data?.message || backendError.message);
      } else {
        console.error('Backend user update error:', backendError);
      }
      throw backendError;
    }
